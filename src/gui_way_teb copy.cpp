...
int main( int argc, char** argv )
{
  ...
  if (enable_homotopy_class_planning)
...
void CB_mainCycle(const ros::TimerEvent& e)
{
  ...
  // }
  //teb local planner
  bool succeed  = planner->plan(initial_pos, goal_pos,&robot_odom.twist.twist,false); // hardcoded start and goal for testing purposes
  if (!success)
  {
