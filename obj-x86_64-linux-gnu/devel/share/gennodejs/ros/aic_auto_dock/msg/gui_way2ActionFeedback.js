...
let gui_way2Feedback = require('./gui_way2Feedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class gui_way2ActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new gui_way2Feedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = gui_way2Feedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new gui_way2ActionFeedback(null);
    ...
    data.feedback = gui_way2Feedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new gui_way2ActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = gui_way2Feedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new gui_way2Feedback()
    }
...
module.exports = gui_way2ActionFeedback;
