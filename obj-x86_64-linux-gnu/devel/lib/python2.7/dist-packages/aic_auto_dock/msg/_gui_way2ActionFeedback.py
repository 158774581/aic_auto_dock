...
"""autogenerated by genpy from aic_auto_dock/gui_way2ActionFeedback.msg. Do not edit."""
import sys
...
class gui_way2ActionFeedback(genpy.Message):
  _md5sum = "1fb53c148af588bac72f320a3ad7bd4c"
  _type = "aic_auto_dock/gui_way2ActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','aic_auto_dock/gui_way2Feedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(gui_way2ActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = aic_auto_dock.msg.gui_way2Feedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = aic_auto_dock.msg.gui_way2Feedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_Q2ifi().pack(_x.feedback.err_msg, _x.feedback.status, _x.feedback.feedback, _x.feedback.remaining_distance, _x.feedback.step_process))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.err_msg, _x.feedback.status, _x.feedback.feedback, _x.feedback.remaining_distance, _x.feedback.step_process,) = _get_struct_Q2ifi().unpack(str[start:end])
      return self
